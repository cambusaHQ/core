 ...
 */
export const datastore = (config, entities) => {
  // Add the subscriber to the metadata storage
  getMetadataArgsStorage().entitySubscribers.push({
    target: EntitySubscriber,
  });
  ...
  dataSource.subscribers.push(new EntitySubscriber());

...
export function generateBlueprintValidations(modelSchema) {
  ...
  return {
    create: inputSchema, // Use schema without auto-generated fields for create
    update: t.Partial(inputSchema), // Use partial schema without auto-generated fields for update
    readAll: t.Object({

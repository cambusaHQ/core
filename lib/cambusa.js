...
import { loadModels, datastore } from '@lib/datastore/datastore.js';
...
class Cambusa {
  ...
  async #loadBlueprints() {
    const models = loadModels(this.config.database);
    const routes = await blueprints(models);
  ...
  async #initializeDatabase() {
    const models = loadModels(this.config.database);
    this.db = await datastore(this.config.database, models);

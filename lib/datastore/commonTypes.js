/**
 * Common data types mapping for various databases and Elysia validation.
 * This object provides a unified interface for defining data types across different database systems,
 * along with their corresponding Elysia validation types and any necessary data transformers.
 */
export const commonTypes = {
  ...
  boolean: {
    ...
    transformer: {
      // For databases that don't have native boolean types, we need to transform between boolean and integer
      sqlite: {
        to: (value) => (value ? 1 : 0),
  ...
  uuid: {
    ...
    transformer: {
      oracle: {
        // Oracle needs special handling for UUIDs

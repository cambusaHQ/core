...
- [Cambusa](#cambusa)
  ...
  - [Blueprints: Automatic CRUD Routes for Models](#blueprints-automatic-crud-routes-for-models)
    - [How Blueprints Work](#how-blueprints-work)
    - [Example of Blueprints in Action](#example-of-blueprints-in-action)
    - [Disabling and Customizing Routes](#disabling-and-customizing-routes)
    - [How to Use Blueprints](#how-to-use-blueprints)
    - [Handling Route Collisions](#handling-route-collisions)
    - [Query Parameters for Blueprints](#query-parameters-for-blueprints)
      - [Pagination](#pagination)
      - [Sorting](#sorting)
      - [Filtering](#filtering)
      - [Population of Related Data](#population-of-related-data)
  - [WebSocket](#websocket)
  - [Middleware System](#middleware-system)
    - [Configuring Middlewares](#configuring-middlewares)
